...
$rye_config = array (
		 ...
		 * This tends to break some plugins that rely on
...
/*				'dance-teachers' => array (
						'labels' => array (
								...
								'edit_item' => 'Edit Dance Teacher',
								'new_item' => 'New Dance Teacher',
								'view_item' => 'View Dance Teacher',
								'search_item' => 'Search Dance Teachers',
								'not_found' => 'No Dance Teachers found' 
						),
						'public' => false,
						'publicly_queryable' => false,
						'show_ui' => true,
...
function _rye_init($rye_config) {
	...
	if (! is_admin ()) :
		foreach ( $rye_config ['javascripts'] as $name => $path ) :
			...
			wp_register_script ( $name, $path, array (), false, $rye_config ['place_javascript_in_footer'] );
			
			wp_enqueue_script ( $name, $path, array (), false, $rye_config ['place_javascript_in_footer'] );
		endforeach
		;
