...
<?php if ( have_posts() ) : ?>
	...
	<div class="c12 row">
		...
		<p class="clr_both txt-right" style="margin: 1em 0 4px; ">
			<a href="#" id="expand-all">Expand All</a> | <a href="#" id="collapse-all">Collapse All</a>
		</p>
		<?php 
		...
		?>
			<div class="q-a-pair">
				<div class="question"><a href="#"><?php echo strip_tags (apply_filters ('the_content', $faq['question'])); ?></a></div>
