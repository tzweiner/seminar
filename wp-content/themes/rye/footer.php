			...
			<h3>Bulgarian Folk Music & Dance Seminar <?php echo date ('Y', strtotime('now')); ?></h3>
		      ...
		      <ul> <?php
								...
								if ($show_evaluation) :
									...
									?>	      	
		      	<li><a href="<?php echo $evaluation_url; ?>" target="_blank">Evaluation
						Form</a></li>
...
$flyer = get_field ( 'seminar_flyer', 'option' );
		      	...
		      	<li class="facebook-icon"><a
					...
					target="_blank"><img alt="Facebook button"
						src="/wp-content/uploads/2015/02/FB_FindUsOnFacebook-1024.png" /></a></li>
			</ul>
...
$flyer_thumbnail = get_field ( 'seminar_flyer_thumbnail', 'option' );
							if ($flyer_thumbnail) :
								?>
      	<div class="middle-column column thumbnail">
			<h3>Seminar Flyer</h3>
			<a href="<?php echo $flyer['url']; ?>" target="_blank"><img
				src=<?php echo $flyer_thumbnail; ?> alt="flyer thumbnail" /></a>
		</div>
      	<?php endif; ?>
      	
      	<div class="right-column column">
			<h3>
				<a href="http://www.eefc.org/" target="_blank">Supporting Partner of
					the<br />East European Folklife Center
				</a>
			</h3>
			<ul>
				<li><a href="http://www.eefc.org/" target="_blank"><img
						src="<?php echo get_bloginfo('template_directory'); ?>/assets/images/eefc_logo.png"
						alt="EEFC logo" /></a></li>
			</ul>
...
<script
	src="<?php echo get_bloginfo('template_directory').'/assets/js/bootstrap.js'; ?>"></script>
<?php wp_footer(); ?>
</body>
</html>
